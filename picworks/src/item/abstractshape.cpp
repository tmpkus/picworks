...
/*!
  ...
  - class PicWorks::AbstractShape implemtation
...
/*!
  \class PicWorks::AbstractShape abstractshape.h
...
/*!
  \fn virtual void PicWorks::AbstractShape::startDraw(QGraphicsSceneMouseEvent * event) = 0
  ...
  \fn virtual void PicWorks::AbstractShape::drawing(QGraphicsSceneMouseEvent * event) = 0
  ...
  \fn virtual void PicWorks::AbstractShape::endDraw(QGraphicsSceneMouseEvent * event) = 0
  ...
  \fn void PicWorks::AbstractShape::isDrawing(bool d)
 ...
 */
AbstractShape::AbstractShape(ProjectScene *s)
        : scene(s)
{
