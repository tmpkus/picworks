...
/*!
  ...
  \fn virtual void Core::ActionContainer::addSeparator() = 0
  \brief Adds a separator into this action container.
...
/*!
  \brief Adds a separator into menu.
 */
void Core::MenuActionContainer::addSeparator()
{
    m->addSeparator();
}
...
/*!
  \brief Adds a separator into menu bar.
  Often this is only effect on Mac.
 */
void Core::MenuBarActionContainer::addSeparator()
{
    mb->addSeparator();
}

Core::ToolBarActionContainer::ToolBarActionContainer()
{
    tb = new QToolBar;
}

void Core::ToolBarActionContainer::addAction(Core::Action *a)
{
    tb->addAction(a->action());
}

void Core::ToolBarActionContainer::addSeparator()
{
    tb->addSeparator();
}
