...
/*!
  ...
  - class Ui::AboutDialog implemtation
...
/*!
  \class Ui::AboutDialog aboutdialog.h
 ...
 */
void Ui::AboutDialog::paintEvent(QPaintEvent* event)
{
    QPainter p(this);
 ...
 */
void Ui::AboutDialog::mousePressEvent(QMouseEvent* event)
{
 ...
 */
void Ui::AboutDialog::showLicenseDialog()
{
    accept();
 ...
 */
void Ui::AboutDialog::showAboutQtDialog()
{
    accept();
    qApp->aboutQt();
}
