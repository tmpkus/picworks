...
/*!
  ...
  - class Ui::TwoColorSelector implemtation
  - class Ui::ColorDrag implemtation
...
/*!
  \class Ui::TwoColorSelector twocolorselector.h
 ...
 */
Ui::TwoColorSelector::TwoColorSelector(QWidget *parent /* = 0 */)
        : QWidget(parent),
          fgColor(Qt::black),
          bgColor(Qt::white)
{
 ...
 */
Ui::TwoColorSelector::~TwoColorSelector()
{
}
...
/*!
  \internal
 */
void Ui::TwoColorSelector::paintEvent(QPaintEvent *event)
{
...
/*!
  \internal
 */
void Ui::TwoColorSelector::paintSection(QPainter * painter, const QRect & rect, const QColor & color)
{
...
/*!
  \internal
 */
void Ui::TwoColorSelector::paintResetSection(QPainter * painter)
{
...
/*!
  \internal
 */
void Ui::TwoColorSelector::paintSwitchSection(QPainter * painter)
{
    painter->setRenderHint(QPainter::Antialiasing);
    QPen pen(Qt::black);
    painter->setPen(pen);
...
/*!
  ...
  \return size hint
 */
QSize Ui::TwoColorSelector::sizeHint() const
{
 ...
 */
QSize Ui::TwoColorSelector::minimumSizeHint() const
{
 ...
 */
void Ui::TwoColorSelector::switchColors() {
    if (fgColor == bgColor) {
        return;
    }
...
/*!
  \internal
 */
void Ui::TwoColorSelector::mousePressEvent(QMouseEvent * event) {
    pressPos = event->pos();
...
/*!
  \internal
 */
void Ui::TwoColorSelector::mouseMoveEvent(QMouseEvent *event)
{
...
/*!
  \internal
 */
void Ui::TwoColorSelector::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton) {
...
/*!
  \internal
 */
void Ui::TwoColorSelector::dragEnterEvent(QDragEnterEvent *event)
{
...
/*!
  \internal
 */
void Ui::TwoColorSelector::dragMoveEvent(QDragMoveEvent *event)
{
    bool acc = false;
    if (event->mimeData()->hasColor()) {
        QColor col(qvariant_cast<QColor>(event->mimeData()->colorData()));
...
/*!
  \internal
 */
void Ui::TwoColorSelector::dropEvent(QDropEvent *event)
{
    QColor col;
    if (event->mimeData()->hasColor()) {
 ...
 */
Ui::ColorDrag::ColorDrag(QWidget *source, const QColor &color, const QString &name)
        : QDrag(source)
{
